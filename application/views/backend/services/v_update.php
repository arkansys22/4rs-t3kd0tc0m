            ...
            echo form_open_multipart('paneladmin/services_update',$attributes); ?>
              ...
              <div class="card-body">
                <div class="form-group">
                  <input type="hidden" name="services_id_session" value="<?php echo $rows['services_id_session'] ?>">
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                          <input type="number" class="form-control" name="services_harga_percent" value="<?php echo $rows['services_harga_percent'] ?>">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="number" class="form-control" name="services_harga_modal" value="<?php echo $rows['services_harga_modal'] ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-12">
                      <select name='products_cat_id_session' class="form-control select2" style="width: 100%;">
                        <?php foreach ($records as $row) {
                          if ($rows['products_cat_id'] == $row['products_cat_id_session']){
                            echo"<option selected='selected' value='$row[products_cat_id_session]'>$row[products_cat_judul]</option>";
                          }else{
                            echo"<option value='$row[products_cat_id_session]'>$row[products_cat_judul]</option>";
                       }
                     } ?>
                    </select>
                    </div>
