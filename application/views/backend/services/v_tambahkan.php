                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="number" class="form-control" name="services_harga" >
                        </div>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                          <input type="number" class="form-control" name="services_harga_percent" placeholder="99">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="number" class="form-control" name="services_harga_modal" >
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="col-sm-12">
                          <select name='products_cat_id_session' class="form-control select2" style="width: 100%;">
                            <?php foreach ($records as $row) {
                              if ($rows['products_cat_id_session'] == $row['products_cat_id_session']){
